...
namespace APICore.API.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Refresh([FromBody] RefreshTokenRequest refreshToken)
        {
            ...
            var savedRefreshToken = await _accountService.GetRefreshTokenAsync(refreshToken.Token, principal.Claims.Where(c => c.Type == ClaimTypes.UserData).First().Value); //retrieve the refresh token from a data store
